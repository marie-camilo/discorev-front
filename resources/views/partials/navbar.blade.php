                        ...
                        @if ($isAdmin)
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle d-flex align-items-center"
                                    href="{{ route('admin.dashboard') }}" role="button" aria-expanded="false">
                                ...
                                <li>
                                    <form action="{{ route('logout') }}" method="POST">
                                        ...
                                        <button type="submit" class="dropdown-item">
                                            <span class="material-symbols-outlined"
                                                style="font-size:16px;">logout</span>
                                            Déconnexion
                                        </button>
                                    </form>
                                </li>
                    ...
                    @else
                        <li class="nav-item">
                            <a href="{{ route('auth', ['tab' => 'login']) }}"
                                class="btn btn-login w-100 d-flex align-items-center gap-2">
            ...
            <div class="offcanvas offcanvas-end d-lg-none" tabindex="-1" id="offcanvasNavbar">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav w-100 mb-3">
                        ...
                        <li class="nav-item"><a class="nav-link text-white"
                                href="{{ route('recruiters.tarifs') }}">Professionnel</a></li>
                        @if (!$isAuthenticated)
                            <li class="nav-item"><a class="btn-login"
                                    href="{{ route('auth', ['tab' => 'login']) }}"> <span
                                        class="material-symbols-outlined">login</span>Connexion</a></li>
                        @endif
                        @if ($isAuthenticated)
                            @if ($isCandidate)
                                <li class="nav-item"><a class="nav-link text-white"
                                        href="{{ route('applications.candidate') }}">Mes candidatures</a></li>
                            @endif
                            @if ($isRecruiter)
                                <li class="nav-item"><a class="nav-link text-white"
                                        href="{{ route('recruiter.jobs.create') }}">Publier une offre</a></li>
                                <li class="nav-item"><a class="nav-link text-white"
                                        href="{{ route('recruiter.jobs.index') }}">Mes offres</a></li>
                                <li class="nav-item"><a class="nav-link text-white"
                                        href="{{ route('cvtheque.index') }}">Cvthèque</a></li>
                            @endif
                            @if ($isAdmin)
                                <li class="nav-item"><a class="nav-link text-white"
                                        href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                            @endif
                            <li class="nav-item"><a class="btn btn-warning w-100"
                                    href="{{ route('recruiters.tarifs') }}">Professionnel</a></li>
                            <li class="nav-item">
