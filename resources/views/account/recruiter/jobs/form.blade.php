    ...
    <div class="container d-flex justify-content-center align-items-start min-vh-100 py-5">
        <div class="card shadow rounded-4 p-4">
            ...
            <form
                ...
                <div class="row mb-3">
                    <label class="form-label me-3" for="salaryMin">Fourchette salariale <small
                            class="text-muted">(€/mois)</small></label>
                    <div class="col-6 mb-3">
                        <label for="salaryMin" class="form-label">Minimum</label>
                        <input type="text" class="form-control" id="salaryMin" name="salaryMin"
                            value="{{ old('salaryMin', $jobOffer['salaryMin'] ?? '') }}">
                    </div>

                    <div class="col-6">
                        <label for="salaryMax" class="form-label">Maximum</label>
                        <input type="text" class="form-control" id="salaryMax" name="salaryMax"
                            value="{{ old('salaryMax', $jobOffer['salaryMax'] ?? '') }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="startDate" name="startDate"
                            value="{{ old('startDate', isset($jobOffer['startDate']) ? \Carbon\Carbon::parse($jobOffer['startDate'])->format('Y-m-d') : '') }}">
                    </div>
                    <div class="col-6">
                        <label for="endDate" class="form-label">Date de fin</label>
                        <input type="date" class="form-control" id="endDate" name="endDate"
                            value="{{ old('endDate', isset($jobOffer['endDate']) ? \Carbon\Carbon::parse($jobOffer['endDate'])->format('Y-m-d') : '') }}">
                    </div>
                </div>
